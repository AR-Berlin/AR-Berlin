...
▄█████████▀           ██               ██             ██                    ██▄████████▀ │AR-Berlin ﹏ @EEFFI
│
تم تطوير وبرمجة السورس من قبل بمطورين سورس AR-Berlinᐂ .
│@EEFFI
@EEFFI
-------------------------------------------------------------------
...
if msg.sender_user_id_ ==  1099083018 then
...
msg.Rank = 3
elseif msg.GroupActive and redis:sismember(AR-Berlin..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
...
if msg.GroupActive and ZISBOT and redis:get(AR-Berlin..'lock_bots_by_kick'..msg.chat_id_) then
kick_user(msg.sender_user_id_, msg.chat_id_)
end
if msg.content_.members_[0].id_ == our_id and redis:get(AR-Berlin..':WELCOME_BOT') then
SUDO_USER = redis:hgetall(AR-Berlin..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(AR-Berlin..':WELCOME_BOT'),[[• مرحباً انا بوت ]]..redis:get(AR-Berlin..':NameBot:')..[[ .
...
print("The File "..name.." Not Runing in The Source AR-Berlin")
end 

end
else
print("The File Script.lua Not Runing in The Source AR-Berlin")
...
download(stk,32)
	...
	if redis:get(AR-Berlin..'group:add'..msg.chat_id_) and (msg.sender_user_id_ == SUDO_ID or redis:sismember(AR-Berlin..':SUDO_BOT:',msg.sender_user_id_) or redis:sismember(AR-Berlin..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) or redis:sismember(AR-Berlin..'owners:'..msg.chat_id_,msg.sender_user_id_) or redis:sismember(AR-Berlin..'admins:'..msg.chat_id_,msg.sender_user_id_)) then 
	msg.Admin = true
	end
	local lock_bots = redis:get(AR-Berlin..'lock_bots'..msg.chat_id_)
	ISBOT = false
	...
	if ZISBOT and redis:get(AR-Berlin..'lock_bots_by_kick'..msg.chat_id_) then
	kick_user(msg.sender_user_id_, msg.chat_id_)
	end
...
kick_user(msg.sender_user_id_,msg.chat_id_)
	...
	redis:hset(AR-Berlin..'username:'..ID,'username',user)
	redis:sadd(AR-Berlin..':MONSHA_BOT:'..k,ID)
	end
	end
	if IDS.Owner then
